...
port(
	...
	in_TTC_TTCC_Tria_cont_quan:in STD_LOGIC_VECTOR ( 31 downto 0 );--in_TTC_TTCCC_Triaxial control quantity
...
--由输入端口in_TTC_TTCC_Tria_cont_quan、得到输出端口out_TTCC_TTC_Tria_cont_inst、
