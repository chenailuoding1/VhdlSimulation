    ...
    begin
        ...
        case sta is
				...
				when sta5=> 
					...
					out_SSDA_SSD_Sun_visi_sign<=RAM_SSDA_Sun_visi_sign(Sun_visi_sign_addr);

					out_calc_inst<='0';

				when sta6=> 

					out_SSDA_SSD_Sun_meas_angl<=RAM_SSDA_Sun_meas_angl(Sun_meas_angl_addr);

				when sta7=> 

					out_SSDA_SSD_Sun_sens_powe_stat<=RAM_SSDA_Sun_sens_powe_stat(Sun_sens_powe_stat_addr);
