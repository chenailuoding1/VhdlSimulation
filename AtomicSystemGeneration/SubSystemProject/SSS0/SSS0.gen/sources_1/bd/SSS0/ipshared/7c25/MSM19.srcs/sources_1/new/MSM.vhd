...
signal RAM_MSM_Curr_mode_work_time: ram_type6;

signal Curr_mode_work_time_addr: integer:=1;

type ram_type7 is array (1 downto 0) of STD_LOGIC_VECTOR ( 31 downto 0 );

signal RAM_MSM_Targ_angl: ram_type7;

signal Targ_angl_addr: integer:=1;

type ram_type8 is array (1 downto 0) of STD_LOGIC_VECTOR ( 31 downto 0 );

signal RAM_MSM_Targ_angu_velo: ram_type8;
